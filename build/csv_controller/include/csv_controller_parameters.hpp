#pragma message("#include \"csv_controller_parameters.hpp\" is deprecated. Use #include <csv_controller/csv_controller_parameters.hpp> instead.")
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("csv_controller"), prefix) {
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        if (param.get_name() == (prefix_ + "csv_name")) {
            updated_params.csv_name = param.as_string();
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "csv_name")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Name of the CSV file to be read";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.csv_name);
          parameters_interface_->declare_parameter(prefix_ + "csv_name", parameter, descriptor);
      }
      // get parameters and fill struct fields
      rclcpp::Parameter param;
      param = parameters_interface_->get_parameter(prefix_ + "csv_name");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "csv_name") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.csv_name = param.as_string();
